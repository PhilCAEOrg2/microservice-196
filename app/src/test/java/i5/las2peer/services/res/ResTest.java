...
public class ResTest {
  ...
  /**
   * 
   * Test for the NewTestCase_ID608653 method.
   * 
   */
  @Test
  public void testNewTestCase_ID608653() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 72207: " + result.getResponse().trim());
      Object response = JSONValue.parse(result.getResponse().trim());
      // Response body has type S11
      assertThat("[961186]", response, both(isA(JSONObject.class)).and(asJSONObject(followsSchema("S11", """
